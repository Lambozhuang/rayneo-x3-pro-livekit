...
android {
    ...
    defaultConfig {
        // Our own id so this installs alongside the upstream starter rather than
        // replacing it. The Kotlin package is left as-is to keep the diff from
        // the starter readable.
        applicationId = "com.rayneo.x3pro.assistant"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
