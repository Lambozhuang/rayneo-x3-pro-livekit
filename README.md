...
| Token endpoint | `http://<lan-ip>:3000/getToken` | `https://livekit.example.com/getToken?k=…` |
...
the candidates name the home IP. So the DNS record for `livekit.example.com` is
